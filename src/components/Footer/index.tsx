export function Footer(){
    ...
    <footer className="bg-bg2 shadow">
        <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
            ...
            <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="https://github.com/victor-palha" className="hover:underline">Victor Palha</a>. All Rights Reserved.</span>
        </div>
    </footer>
    )
}